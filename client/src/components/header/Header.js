...
import {
  Typography, Stack, AppBar, Toolbar, IconButton, Badge, Divider, Hidden,
} from "@mui/material";
import AccountBalanceIcon from "@mui/icons-material/AccountBalance";
import NotificationsIcon from "@mui/icons-material/Notifications";
// import PlaylistAddIcon from "@mui/icons-material/PlaylistAdd";
import { registerCtx } from "../../redux/slice/slice";
...
export default function Header(props) {
  ...
  const setInputValHandler = (e, compnyCode) => {
    ...
    // featching data after selecting value from header dropdown and updating to Reduxctx for leftBa
          ...
          <div className="pc-input-main">
            <form>
              <div className="pc-input-parentflex">
                <input onChange={(e) => { fillDataHandler(e); }} value={formData.stockName} id="stockName" className="pc-input" placeholder="Search stocks ..." type="text" />
                <button className="pc-input-button" type="submit">Submit</button>
              </div>
              <ul className="pc-input-list">

                {list ? list.map((stockCode, index) => (
                  <li key={index} onClick={(e) => setInputValHandler(e, stockCode.compnyCode)}>
                    {" "}
